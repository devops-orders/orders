...
order_model = api.model('Order', {
    ...
    'uuid': fields.String(required=True,
                       description='The uuid generated by customer when creating an order'),
    'price': fields.Integer(required=True,
                     description='The price of the product in the Order'),
    'quantity': fields.Integer(required=True,
                        description='The quantity of the product in the Order'),
    'customer_id': fields.Integer(required=True,
                           description='The unique id of the customer who places the Order'),
    'product_id': fields.Integer(required=True,
                          description='The unique id of the product in the Order'),
    'status': fields.String(required=True,
                         description='The status of the Order(In Progress, Delivered, Cancelled)')
})
